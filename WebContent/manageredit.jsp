...
<body>
  ...
  <div id="inner-page">
        ...
        <div>
			...
			<form name="profile" id="profile" method="post" action="EditProfile" onsubmit="return profilevalidate()">
			<%
			try
			{
...
<td></b></label><input type="text" name="lastname" id="lastname" value="<%=rs.getString("firstname")%> "size="40"></td>
</tr>
<tr>
...
<td></label><input type="number" name="phonenumber" id="phonenumber" value="<%=rs.getString("phoneno") %>" size="40"></td>
</tr>
<tr>
