...
<head>
	...
	System.out.println(studentid+"hi");
	%>
...
<body>
  ...
  <div id="inner-page">
        ...
        <div>
			...
			<form name="profile" id="profile" method="post" action="EditStudent" onsubmit="return profilevalidate()">
			<center>
<div id="detail">
...
<td></label><%=rs.getString("email") %></td>
</tr>
<tr>
...
<td></label><%=rs.getString("branch") %></td>
</tr>
<tr>
