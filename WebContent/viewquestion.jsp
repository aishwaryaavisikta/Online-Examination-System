...
function fun()
{
	...
	if(subjectid==0)
	{
		document.getElementById("result1").innerHTML="SELECT A SUBJECT";
	}
	else
	{
		document.getElementById("result1").innerHTML="";
	...
	//alert(name);
	var url="CheckQuestion?subjectid="+subjectid;
	//alert(url);
    if(window.XMLHttpRequest)	//except IE
		{
			obj=new XMLHttpRequest();
	...
	obj.onreadystatechange=function()
	{
		if (obj.readyState==4 && obj.status==200)
			{
				document.getElementById("result2").innerHTML=obj.responseText;
			}
	} 
}
function ans()
{ 	//alert("hello");
	...
	alert(questionid);
	//alert(name);
	var url="ViewAnswer?questionid="+questionid;
	//alert(url);
    if(window.XMLHttpRequest)	//except IE
		{
			obj=new XMLHttpRequest();
	...
	obj.onreadystatechange=function()
	{
		if (obj.readyState==4 && obj.status==200)
			{
				document.getElementById("result3").innerHTML=obj.responseText;
			}
	}  
}
...
<center>
	...
	<table class="table table-striped" id="tbldata">
		...
		<%}
			...
			out.print("<tr><td><font color='blue'><span id='result1'></span></font></td><td></td><td></td><td></td><td></td></tr><tr><td><label><b>Select Branch :</b></label></td><td></label>");
...
</td><td><font color="blue"><span id="result1" ></span></font></td><td></td><td></td>
</tr>
<tr>		 
<td><lable><b>Select Subject:</b></lable></td><td><span id="result" onchange="" ></span></td><td></td><td></td><td></td>
</tr>
<tr>		 
<td></td><td><span id="result2" onchange="" ></span></td><td></td><td></td><td></td>
</tr>
