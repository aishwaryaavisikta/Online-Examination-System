...
function call()
{
	...
	//alert(name);
	var url="CheckSubject1?branchid="+branchid;
	//alert(url);
...
<form name="addsub" id="addsub" method="post" action="" onsubmit="return addsubvalidate()">
<center>
	<div id="detail">
...
<tr>		 
<td></td><td><span id="result" onchange="" ></span></td><td></td>
</tr>
